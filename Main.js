...
function processRoomCheckOut(row) { GuestManager.processRoomCheckOut(row); }
function processAllCheckOuts() { GuestManager.processAllCheckOuts(); }
function sendCheckInReminders() { GuestManager.sendCheckInReminders(); }
